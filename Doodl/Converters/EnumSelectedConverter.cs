//-----------------------------------------------------------------------
// <copyright file="EnumSelectedConverter.cs" company="EmptyAudio">
...
namespace Doodl.Converters
{
    ...
    public class EnumSelectedConverter : IValueConverter
    {
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return value.ToString() == bool.TrueString ? desired : DependencyProperty.UnsetValue;
        }
    }
}
